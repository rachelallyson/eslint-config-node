...
**Settings**: See [reference/config.mdx](../reference/config.mdx#typescript-configuration)
...
- [Configuration Reference](../reference/config.mdx) - Detailed config options
- [Guides](../guides/quickstart.mdx) - Usage examples
- [Concepts](../concepts.mdx) - Architecture and patterns
